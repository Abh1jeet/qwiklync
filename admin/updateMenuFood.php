	...
	else 
	{
		...
		if(isset($_POST['submitButton']))
		{
			...
			
			{
				...
				//error update query is not running
				$updateQuery= "UPDATE `food` SET `foodId`=`".$foodId."`,`restaurantId`=`".$restaurantId."`,`foodDetails`=`".$foodDetails."`,`foodName`=`".$foodName."`,`foodDescription`=`".$foodDescription."`,`type`=`".$type."`,`oldPrice`=`".$oldPrice."`,`newPrice`=`".$newPrice."`,`category`=`".$category."` WHERE `foodId`=`".$foodId."`";
				...
				if($updateResult==True)  
				{
					...
					header('Location:updateMenuFood.php?sucess='.$sucess);
				}
				else
				{
					$error = "Updation Failed!";
					header('Location:updateMenuFood.php?foodId='.$foodId.'&error='.$error.'&submitButton=');
				}
					...
					<?php
							...
							if(isset($_GET['foodId']))
							{
								...
								if(!$foodQueryResultsCount==1)
								{
									...
									header('Location:updateMenuFood.php?error='.$error.'&submitButton=');
								}
												...
												<div class="col-sm-12">
													<div class="panel panel-primary">
														<div class="panel-heading">
															<h3 class="panel-title">Update Food Details</h3>
														</div>
														<div class="panel-body">
															<form class="form-horizontal" role="form" method="post" action="<?php echo $current_file; ?>" enctype="multipart/form-data">
																...
																<div class="form-group">
																	...
																	<div class="col-md-10">
																		<input type="text" name="restaurantId" class="form-control" placeholder="RST0x" value="<?php echo $restaurantId;?>" required="required">
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-md-10">
																		<input type="textarea" name="foodDetails" class="form-control"  value="<?php echo $foodDetails;?>" placeholder="It is very famous in China" required="required">
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-md-10">
																		<input type="text" name="foodName" class="form-control" value="<?php echo $foodName;?>" placeholder="Kadahi Paneer" required="required">
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-md-10">
																		<input type="textarea" name="foodDescription" class="form-control" value="<?php echo $foodDescription;?>" placeholder="Yummy and Spicy in Taste" required="required">
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-md-10">
																		<input type="text" name="type" class="form-control" value="<?php echo $type;?>" placeholder="Vegetarian" required="required">
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-md-10">
																		<input type="float" name="oldPrice" class="form-control" value="<?php echo $oldPrice;?>" placeholder="72.5" required="required">
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-md-10">
																		<input type="float" name="newPrice" class="form-control" value="<?php echo $newPrice;?>" placeholder="75.5" required="required">
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-md-10">
																		<input type="text" name="category" class="form-control" value="<?php echo $category;?>" placeholder="Indian" required="required">
																	</div>
																</div>
																...
																?>
																<button type="submit" style="float: right;" class="btn btn-info waves-effect waves-light m-l-10" name="submitButton">Update Food Details</button>
															</form>
														</div>
													</div>
												</div>
