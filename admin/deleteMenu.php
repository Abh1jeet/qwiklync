                ...
                <div class="container">
					...
					<?php
						 ...
						 if(isset($_GET['submit']))
						 {
							...
							if($option=="deleteFood")
							{
								header('Location:deleteMenuFood.php');
							}
							else
							{
								header('Location:deleteMenuComplete.php');
							}
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<select class="form-control" name="option">
														<option value="deleteFood" >Delete Single Food Details</option>
														<option value="deleteComplete" >Delete Complete Menu</option>
													</select>
												</div>
											</div>
											<?php
