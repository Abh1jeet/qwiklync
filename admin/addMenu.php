	...
	else 
	{
		...
		if(isset($_POST['submitButton']))
		{
			...
			if(!empty($fileName))
			{
				...
				{
					$error = "Insertion Failed! Only CSV File is allowed.Try again";
				}
			}
		}
							...
							<div class="panel panel-primary">
                                ...
                                <form class="form-horizontal" role="form" method="post" action="<?php echo $current_file; ?>" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Upload Menu CSV File</label>
                                        <div class="col-md-10">
                                    ...
                                    ?>
                                    <button type="submit" style="float: right;" class="btn btn-info waves-effect waves-light m-l-10" name="submitButton">Add Menu Details</button>
                                </form>
                            </div>
                        </div>
                    </div>
