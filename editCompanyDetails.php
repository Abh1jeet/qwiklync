...
if(isset($_POST['editJob'] ) && isset($_POST['jobId']) )  {
...
if(isset($_POST['companyName'] ) && isset($_POST['companyType']) && isset($_POST['companySize']) && isset($_POST['companyKind']) && isset($_POST['companySite']) && isset($_POST['companyFounded']) && isset($_POST['companyAddress']) && isset($_POST['companyEmail']) && isset($_POST['companyPhone'])  && isset($_POST['aboutCompany']) && isset($_POST['companySpeciality']) )  {
            ...
            /*if(substr($logoType,0,5)=="image") 
            {
                ...
                {	
                	if($editJob == "yes")
                		header('Location:editJob.php?jobId='.$jobId.'&editJob="yes"');

                 	$error = "oh yeah";
                 //header('Location:single-job.php?comp')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div class="post-job2-panel">
                            <form class="row" action="<?php echo $_SERVER['PHP_SELF'];?>?compId=<?php echo $id; ?>&edit=yes" method="POST" name="postJobForm" enctype="multipart/form-data">
                           ...
                           <div class="col-md-2 col-sm-2 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <br>
                                        ...
                                        <select class="questions-category form-control" name="companyType" required="required" value="<?php echo $industryType;?>">
                                			...
                                			<div class="col-md-9 col-sm-7 col-xs-12">
                           					 <div class="profile-info">
				                                	...
				                                	<form action="#" method="POST">
				                                	 ...
				                                	 <button class="btn btn-default pull-right" name="submitCompany">
